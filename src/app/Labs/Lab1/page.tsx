    ...
    <div id="wd-lab1">
      ...
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          <input placeholder="vedant" id="wd-text-fields-username" /> <br />
          ...
          <input type="text" placeholder="Vedant" defaultValue="Shah" 
          ...
          <input type="number" defaultValue="100000" placeholder="1000" 
                 id="wd-text-fields-salary-start"/>
          <br/>
          <label htmlFor="wd-text-fields-rating">Rating:</label>
          <input type="range" defaultValue="4" max="5" placeholder="Doe" 
      ...
      Checkout my 
      <a href="https://github.com/YOUR_USERNAME/kambaz-next-js" id="wd-github"> GitHub Repository</a>
      <br/>
      </div>
    </div>
  );
